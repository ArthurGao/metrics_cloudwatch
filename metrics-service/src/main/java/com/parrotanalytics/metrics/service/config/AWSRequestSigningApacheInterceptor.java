...
public class AWSRequestSigningApacheInterceptor implements HttpRequestInterceptor
{
     ...
     *
     * @param service
     *            service that we're connecting to
     * @param signer
     *            particular signer implementation
     ...
     *
     * @param params
     *            list of HTTP query params as NameValuePairs
    ...
    private static boolean skipHeader(final Header header)
    {
        return ("content-length".equalsIgnoreCase(header.getName()) && "0".equals(header.getValue())) // Strip
                                                                                                      // Content-Length:
                                                                                                      // 0
                || "host".equalsIgnoreCase(header.getName()); // Host comes from
                                                              // endpoint
    }

    /**
     * @param mapHeaders
     *            Map of header entries
